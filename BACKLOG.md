...
1. 🔴 **Auditable provenance / process versioning for data
   ...
   persistence umbrella (Phase 4r friction #5).
...
5. 🟡 **Dynamic sidebar auto-width for long labels
   (USER-FLAGGED).** Auto-bump the PanedWindow sash position to
   fit the widest label-cell natural width. **Cross-ref:** see
   the new register entry; cross-refs CS-30 + CS-33.
