...
class TestPeakPickingPanel(unittest.TestCase):
    ...
    def test_no_inline_title_label_inside_panel_body(self):
        ...
        # "Peak picking" label — the CollapsibleSection wrapper (CS-21)
        ...
        offending = [
            ...
            if lbl.cget("text") == "Peak picking"
        ]
        self.assertEqual(
            offending, [],
            "panel body must not carry an inline 'Peak picking' label "
    ...
    def test_apply_with_different_params_creates_new_node(self):
        ...
        self.panel._prominence.set("0.2")
        self.assertIsNotNone(self.panel._apply())
        self.assertEqual(len(self.graph.nodes), n_after_first + 2)
